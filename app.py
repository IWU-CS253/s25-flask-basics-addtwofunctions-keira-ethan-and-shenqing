...
def wordstatsindex():
    if request.method == 'POST':
        ...
        char_count = wordstats.character_count(user_string)
        letter_count = wordstats.num_letters(user_string)
        return render_template('wordstats.html', average_length=average_length,
                               word_count=word_count, char_count=char_count, letter_count=letter_count)
    else:
        return render_template('wordstats.html', average_length=None, word_count=None,
                               char_count=None, letter_count=None)
